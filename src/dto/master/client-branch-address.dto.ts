...
export class ClientBranchAddressDto {
  @IsEnum(AddressType)
  type!: AddressType;

  @ValidateIf((dto: ClientBranchAddressDto) => dto.type === AddressType.PINCODE)
  @IsDefined()
  @ValidateNested()
  ...
  @IsOptional()
  @ValidateIf(
    (dto: ClientBranchAddressDto) => dto.type === AddressType.COORDINATES,
  )
  @IsDefined()
  @ValidateNested()
